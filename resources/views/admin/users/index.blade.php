@extends('admin/layout') @section('title') {{ __('Users') }} @endsection @section('content')
...
{{ __('Users') }}
            ...
            <div class="heading-elements div_btn">
                <a href="{{ route('admin.users.create') }}" class="btn bg-blue btn-labeled heading-btn btn_add"><b><i class="icon-plus3 "></i></b>{{ __('create user') }}</a>
    ...
    <div class="content">
        ...
        <div class="empty_state text-center">
            ...
            <a href="{{ route('admin.users.create')}}" class="btn bg-blue btn-labeled heading-btn showUploader2"><b>
    <i class="icon-plus3"></i></b> {{ __('Add new User') }} </a>
        ...
        <div class="panel panel-flat" id="search_box" style="display : none;">
            ...
            <div class="panel-body">
                <form action="{{ route('admin.users.home') }}" method="get" class="main-search">
                    {!! csrf_field() !!}
            ...
            <table class="table ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="{{ __('statue') }}">{{ $user->statue }} </td>
                        <td data-labe="{{ __('edit') }}" class="text-center">
                            <a class="edit btn btn-success btn-block hidden-md hidden-lg hidden-sm" href="{{ route('admin.users.edit',['id' => $user->id]) }}">edit</a>
                            <ul class="icons-list hidden-xs">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a>
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a href="{{ route('admin.users.edit',['id' => $user->id]) }}" class="text-primary-600">
                                                <i class="icon-pencil7 position-left"></i>{{ __('Edit') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.users.delete',['id'=> $user->id]) }}" class="text-danger-600">
