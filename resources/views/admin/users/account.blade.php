 @extends('admin/layout') @section('title') {{ __('Account User ') }} @endsection @section('content')
        ...
        <div class="col-md-8">
            <div class="panel panel-flat col-md-12">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="{{ route('admin.account.info.update') }}">
                        {!! csrf_field() !!}
            ...
            <div class="panel panel-flat col-md-12">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" id="AdminPasswords" method="post" action="{{ route('admin.account.password.update') }}">
                        {!! csrf_field() !!}
                        <fieldset class="content-group">
                            <legend class="text-bold"></legend>
                            <div class="form-group">
