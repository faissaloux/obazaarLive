    ...
    <div class="profile-wrapper-area py-3">
      ...
      <div class="card user-data-card">
        <div class="card-body">
          ...
          <!-- Edit Profile-->
          <div class="edit-profile-btn mt-3"><a class="btn btn-info w-100" href="{{ route('mobile.store.profile.edit', ['store' => $store, 'store_category' => $store_category]) }}"><i class="lni lni-pencil {{ System::isRtl() ? 'ms-2':'me-2'}}"></i>{{ __('Edit Profile') }}</a></div>
        </div>
      </div>
    </div>
  </div>
