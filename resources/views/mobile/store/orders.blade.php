                        ...
                        <!-- Accordian Card-->
                            <div class="card accordian-card seller-card clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7"><a href="{{ route('orders_detail',['id' => $order->id , 'store' => \Session::get('store') ]) }}">{{ $order->id }}</a></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7"><a href="{{ route('orders_detail',['id' => $order->id , 'store' => \Session::get('store') ]) }}">{{ __('order details') }}</a></div>
                                </div>
                                </div>
                            </div>
                        </div>
