...
<div class="page-header page-header-default ">
    ...
    <div class="page-title">
        ...
        <div class="heading-elements div_btn">
             <a href="{{ route('manager.pages.create') }}" class="btn bg-blue btn-labeled heading-btn btn_add"><b>
...
<div class="content">
    ...
    @if ($pages->isEmpty())
      <div class="empty_state text-center">
        ...
        <a href="{{ route('manager.pages.create') }}" class="btn bg-blue btn-labeled heading-btn"><b><i class="icon-plus3"></i></b>
...
<div class="panel panel-flat" id="search_box" style="display : none;" >
    ...
    <div class="panel-body">
        <form action="{{ route('manager.pages.home') }}" method="get" class="main-search">
            {!! csrf_field() !!}
...
<div class="panel panel-flat table-panel table-responsive">
        <table class="table ">
            ...
            <tr>
                ...
                <td><a href="{{ route('manager.pages.edit', [ 'id' => $page->id ]) }}"></a>
                <a class="edit btn btn-success btn-block hidden-md hidden-lg hidden-sm"  href="{{ route('manager.pages.edit',['id' => $page->id]) }}">edit</a>
                ...
                <li>
                    ...
                    <a target="_blank" href="{{ route('basepage',['slug' => $page->slug ]) }}" class="text-success-600">
                        <i class="icon-eye position-left"></i>{{ __('View') }}
                    </a>

                </li>
                <li>
                <a href="{{ route('manager.pages.edit',['id' => $page->id]) }}" class="text-primary-600">
                <i class="icon-pencil7 position-left"></i>{{ __('Edit') }} 
                </a>
                </li>
                <li>
                <a href="{{ route('manager.pages.delete',['id' => $page->id]) }}" class="text-danger-600">
                <i class="icon-cross2 position-left"></i>{{ __('Delete') }}
                </a>
                </li>
                <li>
                <a href="{{ route('manager.pages.duplicate',['id' => $page->id]) }}" class="text-bg-info">
