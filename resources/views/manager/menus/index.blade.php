...
<div class="content-wrapper">
    ...
    <div id="modal_default" class="modal fade">
        <div class="modal-dialog">
            ...
            <form action="{{ route('manager.menus.store') }}" id="CreateMenu" method="POST">
                @csrf
          ...
          <div class=" navbar navbar-default navbar-component navbar-xs" style="padding:10px;">
              ...
              <div class="col-md-3">
                  ...
                  <select class="form-control menuListSelect" style="width:100%;">
                      ...
                      <option value="{{ route('manager.menus.edit',['id' => $item->id ]) }}">{{ $item->name }}</option>
                      @endforeach
                  </select>
    ...
    {!! $menu->printInput() !!}
        ...
        <div class="col-md-9">
            ...
            <form action="{{ route("manager.menus.update") }}" method='post'>
            @csrf
          ...
          <div class="row output-container">
            <div class="col-md-offset-1 col-md-10">
                ...
                <p>
                    <a href="{{ route('manager.menus.delete',['id' => $menu->id]) }}" class="text-danger delete-menu-link" style="margin-right:15px;" href="">
                        {{ __('delete menu') }}
                    </a>
                </p>
            </div>
