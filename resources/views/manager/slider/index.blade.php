@extends('manager/layout') @section('title') {{ __('Slider') }} @endsection @section('content')
...
<div class="content-wrapper">
    ...
    <div class="page-header page-header-transparent">
        <div class="page-header-content">
            ...
            <div class="heading-elements div_btn">
                <a href="{{ route('manager.slider.create')}}" class="btn bg-blue btn-labeled heading-btn btn_add"><b><i class="icon-plus3"></i></b>{{ __('add new slider') }} </a>
    ...
    <div class="content">
        ...
        <div class="empty_state text-center">
            ...
            <a href="{{ route('manager.slider.create')}}" class="btn bg-blue btn-labeled heading-btn showUploader2"><b>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="{{ __('edit') }}"> <a class="edit btn btn-success btn-block hidden-md hidden-lg hidden-sm" href="{{ route('manager.slider.edit',['id' => $slider->id]) }}">edit</a>
                            <ul class="icons-list hidden-xs">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a href="{{ route('manager.slider.edit',['id' => $slider->id]) }}" class="text-primary-600">
                                                <i class="icon-pencil7 position-left"></i>{{ __('Edit') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('manager.slider.delete',['id' => $slider->id]) }}" class="text-danger-600">
                                                <i class="icon-cross2 position-left"></i>{{ __('Delete') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('manager.slider.duplicate',['id' => $slider->id]) }}" class="text-bg-info">
