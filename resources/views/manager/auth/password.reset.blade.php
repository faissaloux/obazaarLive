...
<div class="page-content">
    <div class="content-wrapper">
        <div class="content">
					...
					<!-- Password recovery -->
					<form  action="{{ path_for('postNewPassword') }}"  id="ResetPasswordsForm" method="post" autocomplete="off">
						{!! csrf_field() !!}
				...
				<div id="resultpassword"></div>
							<div class="text-center">
								...
								<h5 class="content-group">{{l.Auau.4}} <br><br>
							...
							<div class="form-group has-feedback">
								<input type="password" class="form-control frequired" id="password" name="password" placeholder="{{l.Auau.12}}">
							</div>
							<div class="form-group has-feedback">
								<input type="password" class="form-control frequired" id="confirmPassword" name="confirmPassword" placeholder="{{l.Auau.13}}">
							</div>
                            <input type="hidden" value="{{reset_token}}" name="reset_token" />
							<button type="submit" class="btn bg-blue btn-block"> {{l.Auau.14}} <i class="icon-arrow-left13 position-right"></i></button>
						</div>
					</form>
					<!-- /password recovery -->
