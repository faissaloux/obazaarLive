...
<div class="ps-product--cart-mobile">
   <div class="tachbkat align-self-center">
      ...
      <a class="ps-product__remove" href="<?php echo route('cart.remove', ['id' => $product->rawId() , 'store' => $store ])   ?>"><i class="icon-cross"></i></a>
   </div>
   <div class="ps-product__thumbnail"><a href="<?php echo route('shop.product',['id' => $product['id'] , 'store' => $store ])  ?>"><img src="{{ $product['thumbnail'] }}" alt=""></a></div>
   <div class="ps-product__content lhsabbdyaltele"><a href="<?php echo route('shop.product',['id' => $product['id'] , 'store' => $store ])  ?>">{{ $product['name'] }}</a><br>
...
<div class="ps-cart__footer ajax">
   ...
   <figure><a class="ps-btn" href="<?php echo route('checkout', ['store' => $store ])  ?>">{{ __('Checkout') }}</a></figure>
</div>
