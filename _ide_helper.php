...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function dispatchEvent($event, $payload = [], $halt = false)
        {
                        /** @var \Overtrue\LaravelShoppingCart\Cart $instance */
                        return $instance->dispatchEvent($event, $payload, $halt);
        }
                    /**
         ...
         * @static 
         */ 
        public static function add($id, $name = null, $qty = null, $price = null, $attributes = [])
        {
                        /** @var \Overtrue\LaravelShoppingCart\Cart $instance */
         ...
         * @return array|\Overtrue\LaravelShoppingCart\Collection 
         * @static 
         */ 
...
namespace  { 
            ...
            class System extends \App\Helpers\System {}
